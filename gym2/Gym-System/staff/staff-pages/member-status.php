            ...
            <div class='widget-content nopadding'>
              ...
              while ($row = mysqli_fetch_array($result)) { ?>
                ...
                <tbody>
                  ...
                  <td>
                    <div class='text-center'><?php echo $row['plan']; ?> Days</div>
                  </td>
                  <td>
                    <div class='text-center'><?php if ($row['status'] == 'Active') {
                                                echo '<i class="icon icon-circle" style="color:green;"></i> Active';
                                              } else {
                                                echo '<i class="icon icon-circle" style="color:red;"></i> Expired';
                                              } ?></div>
                  </td>
                </tbody>
              <?php $cnt++;
