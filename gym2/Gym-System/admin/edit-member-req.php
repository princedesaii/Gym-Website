  ...
  <div id="content">
    ...
    <form role="form" action="index.php" method="POST">
      ...
      if (isset($_POST['fullname'])) {
        ...
        //update query
        $qry = "update members set fullname='$fullname', username='$username',dob='$dob', gender='$gender', services='$services', amount='$totalamount', plan='$plan', address='$address', contact='$contact' where user_id='$id'";
