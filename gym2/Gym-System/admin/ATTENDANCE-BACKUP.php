...
<body>
  ...
  <!--Header-part-->
  <div id="header">
    <h1><a href="dashboard.html">Perfect 365 hc Admin</a></h1>
  </div>
  <!--close-Header-part-->
              ...
              while ($row = mysqli_fetch_array($result)) { ?>
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    <td>
                      <div class='text-center'><a href='actions/check-attendance.php?id=<?php echo $row['user_id']; ?>'><button class='btn btn-info'>Check In <i class='icon icon-map-marker'></i></button> </a></div>
                    </td>
