...
<head>
    <title>365 Health Club System Admin</title>
    <meta charset="UTF-8" />
...
<body>
    ...
    <form role="form" action="index.php" method="POST">
        ...
        if (isset($_POST['fullname'])) {
            ...
            $qry = "insert into members(fullname,username,password,dob,gender,services,amount,plan,address,contact,status) values ('$fullname','$username','$password', CURRENT_TIMESTAMP,'$gender','$services','0','$plan','$address','$contact','Pending')";
