<?php
include_once './customer/includes/db_connect.php';
// 
// page_protect();
?>
...
<head>
	...
	<title>Health Club 365 | New User</title>
...
<body class="page-body  page-fade" onload="collapseSidebar()">
	...
	<div class="page-container sidebar-collapsed" id="navbarcollapse">
		...
		<!-- <div class="logo"> -->
		<!-- <a href="main.php"> -->
		<!-- <img src="../../images/Logoimg1.png	" alt="" width="192" height="80" /> -->
		<!-- </a> -->
		<!-- </div> -->
		...
		<div class="a1-container a1-small a1-padding-32" style="margin-top:2px; margin-bottom:2px;">
			<div class="a1-card-8 a1-light-gray" style="width:500px; margin:0 auto;">
				...
				<form id="form1" name="form1" method="post" class="a1-container" action="../dashboard/admin/new_submit_user.php">
