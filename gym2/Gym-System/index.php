    ...
    <div id="loginbox">
        <form id="loginform" method="POST" class="form-vertical" action="#">
            <div class="control-group normal_text">
                <!-- <h3><img src="img/logoimg.png" alt="Logo" style="width: auto\9; height: auto; max-width: 40%; vertical-align: middle; border: 0; -ms-interpolation-mode: bicubic;" /></h3> -->
                <h3>💪𝟥𝟨𝟧 <span style="color: red; font: size 40px;"> 𝐻𝐸𝒜𝐿𝒯𝐻 </span>𝒞𝐿𝒰𝐵🏋‍♂</h3>
            </div>
